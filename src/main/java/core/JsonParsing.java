    ...
    public static void main(String[] args) throws IOException {
        ...
        while (parser_01.hasNext()) {
            ...
            if (e == Event.KEY_NAME) {
                ...
                String s = parser_01.getString();
                if (s.equals(element_02)) {
                    parser_01.next();
